<?php
 ...
 class InstitutNormalizer implements ContextAwareNormalizerInterface , NormalizerAwareInterface
 {
     ...
     {
         return !isset($context[self::ALREADY_CALLED]) && $data instanceof Institut;
