 ...
 */
final class Version20220914154822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE absence (id INT AUTO_INCREMENT NOT NULL, assiduite_id INT DEFAULT NULL, nbre_absence INT DEFAULT NULL, absence_justifie INT DEFAULT NULL, date DATE DEFAULT NULL, INDEX IDX_765AE0C91EFC89DD (assiduite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE annee_academic (id INT AUTO_INCREMENT NOT NULL, institut_id INT DEFAULT NULL, INDEX IDX_6BCF41E8ACF64F5F (institut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, delegue_1_id INT DEFAULT NULL, delegue_2_id INT DEFAULT NULL, annee_academic_id INT DEFAULT NULL, niveau_id INT DEFAULT NULL, diplome_id INT DEFAULT NULL, nom_classe VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8F87BF96FBBE984C (delegue_1_id), UNIQUE INDEX UNIQ_8F87BF96E90B37A2 (delegue_2_id), INDEX IDX_8F87BF962309E526 (annee_academic_id), INDEX IDX_8F87BF96B3E9C81 (niveau_id), INDEX IDX_8F87BF9626F859E2 (diplome_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE intitule_diplome (id INT AUTO_INCREMENT NOT NULL, diplome_id INT DEFAULT NULL, intitule VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_52596E0726F859E2 (diplome_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, bulletin_id INT DEFAULT NULL, matiere_id INT DEFAULT NULL, cc1 INT DEFAULT NULL, cc2 INT DEFAULT NULL, examen INT DEFAULT NULL, INDEX IDX_CFBDFA14D1AAB236 (bulletin_id), INDEX IDX_CFBDFA14F46CD258 (matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_bourse (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) DEFAULT NULL, pourcentage DOUBLE PRECISION DEFAULT NULL, detail VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
