 ...
 */
final class Version20230601092516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat ADD user_create_id INT DEFAULT NULL, ADD file LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat DROP user_create_id, DROP file');
    }
}
